...
Rainfall has less noticable impact on sales. People spend more per transaction when there is heavy rain but the difference is not significant. When there is light rain the store sells more on the average day when compared to no rain and heavy rain. 
