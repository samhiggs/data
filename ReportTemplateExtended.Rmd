...
We conclude that temperature, rainfall and time of day seem to have noticable effect on sales. It is therefore valueable to look at weather forecasts when deciding what products to stock and promote. 
Temperature seems to have the most impact on sales especially during milder temperatures (15 - 40 degrees) rather than more extreme temperature (10 - 15 degrees and 40 - 45 degrees), it is though worth mentioning that the more extreme temperatures have way fewer data points than milder temperatures. 
Rainfall has less noticable impact on sales. People spend more when there is heavy rain but the difference is not significant. When there is light rain the store sells more on the average day when compared to no rain and heavy rain. It's worth mentioning that heavy rain has the smallest dataset. 
